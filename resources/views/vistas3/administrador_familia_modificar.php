        ...
        <main class="page-content">
            ...
            <div class="contenido-main">
                <div class="titulo-formulario">
                    <h2>Modificar datos de <span>Familia Profesional</span></h2>
                </div>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombre" placeholder="escriba el nombre de la familia profesional a modificar" required autofocus>
                    </div>
