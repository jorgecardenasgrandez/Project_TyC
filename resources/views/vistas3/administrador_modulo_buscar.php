        ...
        <main class="page-content">
            ...
            <div class="contenido-main">
                <div class="titulo-formulario">
                    <h2>Buscar datos de <span>Módulo</span></h2>
                </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3">
                            <div id="imaginary_container"> 
                                <div class="input-group stylish-input-group">
                                    <input id="id" name="id" type="text" class="form-control" autocomplete="off" placeholder="Escriba el nombre del módulo">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="opcion-ocupacional" readonly="">
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="fecha-inicio" readonly="">
                        </div>
                        <div class="form-group col-md-4">
                            <label class="titulo-label">Fecha de fin</label>
                            <input type="text" class="form-control" name="fecha-fin" readonly="">
                        </div>
                        <div class="form-group col-md-4">
                            <label class="titulo-label">Duración en horas</label>
                            <input type="number" class="form-control" name="duración" readonly="">
                        </div>
                    </div>


                    <div class="botones">
                        <button type="submit" class="btn boton-registrar btn col-xs-4">Exportar</button>
