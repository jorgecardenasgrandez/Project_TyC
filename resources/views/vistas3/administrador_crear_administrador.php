        ...
        <main class="page-content">
            ...
            <div class="contenido-main">
                <div class="titulo-formulario">
                    <h2> <span> Crear Administrador </span></h2>
                </div>
                ...
                <form>
                    <fieldset>
                        <div>
                            <div class="form-group">
                                <label class="titulo-label"> Nombre de Usuario </label>
                            ...
                            <div class="form-group">
                                <label class="titulo-label">Confirmar Contraseña </label>
                    ...
                    <br>
                    <div class="botones">
                        <button type="submit" class="btn boton-registrar btn-success col-xs-4">Crear Administrador</button>
                        <button type="submit" class="btn boton-registrar btn-success col-xs-4">Ver Lista de Administradores </button>
                    </div>
                    <br>
