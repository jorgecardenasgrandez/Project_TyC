        ...
        <main class="page-content">
            ...
            <div class="contenido-main">
                <div class="titulo-formulario">
                    <h2>Editar datos de <span>Opción Ocupacional</span></h2>
                </div>
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombre" placeholder="Ingrese el nombre de la opcion ocupacion a eliminar" required autofocus>
                    </div>

                    <div class="form-group">
                        <label class="titulo-label">Familia profesional</label>
                        <input type="text" class="form-control" name="familia-profesional" readonly="">
                    </div>
