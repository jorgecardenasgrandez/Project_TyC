    ...
    public function boot()
    {
        ...
        */
        ...
        View::composers(['App\Http\ViewComposers\ProfileProfesorComposer' => ['profesor_index','profesor_informacion','profesor_ver_modulo','profesor_ingresa_nota','profesor_cambiar_contraseña','profesor_alumnos_x_modulo','profesor_ingreso_notas'],
                       'App\Http\ViewComposers\ProfileAdminComposer' => ['index','alumno_registrar','matricula_formulario','asignar_profesor','create_profesor','profesor_modificar','modulo_registrar','opcion_registrar','familia_registrar','alumnos_matriculados','administrador_listar_profesores'],
